...
export const intentPhraseKnowledge: IntentPhrase[] = [
  ...
  { canonical: "recommend_different", intent: "recommend_different", aliases: ["غيرها", "غيره", "غير", "بدلها", "شي ثاني", "فكرة ثانية", "مو هذي", "ما أبيها", "ما اباها", "ما عجبني", "مو مناسب", "another idea", "something different"] },
