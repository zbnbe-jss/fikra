...
const FEATURE_CARDS = [
  { labelAr: "ميزانيتك", labelEn: "Your budget", icon: Wallet, delay: "animate-delay-100", color: "from-fikra-500 to-fikra-600" },
  { labelAr: "اهتماماتك", labelEn: "Your interests", icon: Sparkles, delay: "animate-delay-300", color: "from-azure-500 to-azure-600" },
  { labelAr: "وقتك", labelEn: "Your time", icon: Clock, delay: "animate-delay-500", color: "from-fikra-400 to-azure-500" },
  { labelAr: "طريقة عملك", labelEn: "Your work style", icon: User, delay: "animate-delay-700", color: "from-azure-400 to-fikra-500" },
];
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 lg:grid-cols-2 lg:px-8 lg:py-24">
          <div className="animate-fade-up">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button onClick={() => navigate("/quiz")} className="btn-primary group text-base">
          ...
          <div className="relative flex h-[400px] items-center justify-center lg:h-[500px]">
            ...
            <div className="absolute h-56 w-56 rounded-full bg-gradient-to-br from-fikra-300/30 to-azure-300/30 blur-2xl animate-pulse-soft" />
            <div className="relative grid grid-cols-2 gap-4 sm:gap-6">
              {FEATURE_CARDS.map((f) => (
                <div
                  key={f.labelEn}
                  className={`card animate-float ${f.delay} shimmer-hover flex flex-col items-center gap-3 p-6`}
                >
                  <div
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {steps.map((s, u) => (
              <div
                key={s.num}
                className="card card-hover group relative p-8 animate-fade-up"
                style={{ animationDelay: `${u * 150}ms` }}
              >
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-7">
            <button
              ...
              className={`card flex flex-col items-center gap-2 p-4 text-center transition-all duration-300 ${
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {featured.map((idea, u) => (
              <div key={idea.id} className="animate-fade-up" style={{ animationDelay: `${u * 100}ms` }}>
                <IdeaCard idea={idea} />
              </div>
            ))}
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-fikra-600 to-azure-600 px-8 py-16 shadow-float lg:px-12 lg:py-20">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="mt-8 inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-base font-semibold text-fikra-700 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95"
              >
                {t("ابدأ الاختبار", "Take the Quiz")}
                <ArrowLeft size={20} />
              </button>
